...
import org.entur.bahamut.peliasDocument.placeHierarchy.PlaceHierarchies;
...
public class NetexEntitiesIndexToPeliasDocument {
    ...
    public static List<PeliasDocument> convert(NetexEntitiesIndex netexEntitiesIndex,
        ...
        var topographicPlaceToPeliasMapper = new TopographicPlaceHierarchiesToPeliasDocumentMapper(1L, Collections.emptyList());
        ...
        var stopPlaceDocuments = netexEntitiesIndex.getSiteFrames().stream()
                ...
                .flatMap(placeHierarchies -> stopPlaceToPeliasDocumentMapper.toPeliasDocuments(placeHierarchies).stream())
