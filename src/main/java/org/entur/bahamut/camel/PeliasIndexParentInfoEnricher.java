...
import org.entur.bahamut.camel.adminUnitsRepository.AdminUnitRepository;
import org.entur.bahamut.camel.adminUnitsRepository.TopographicPlaceAdapter;
...
public class PeliasIndexParentInfoEnricher {
    ...
    public void addMissingParentInfo(@Body Collection<ElasticsearchCommand> commands,
                                     @ExchangeProperty(value = GEOCODER_ADMIN_UNIT_REPO) AdminUnitRepository adminUnitRepository) {
